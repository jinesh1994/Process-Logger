       ...
       Inner: 			while(true)
        			{
                        ...
                        break;
        					...
        					{
        						System.out.println("Some packet must have been lost, the logging process will continue neverthless");
        	               ...
        	               handle.InsertIntoLog(stri); 
        						...
        						}catch(Exception e){System.out.println("In inner catch");e.printStackTrace();}
        				}
        	}
