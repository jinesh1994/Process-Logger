...
public class UDPServer implements Serializable {
    ...
    public static void main(String[] a) throws IOException {
        ...
        ////scann hostname from user at runtime
        ...
        //ia2 = InetAddress.getByAddress(IP2);    //for ip address of (gui)
        ...
        while (true) {
            ...
            try {
                ...
                //System.out.println("packet recieved " + cstr);
                ...
                //System.out.println("error in 1st while " + e);
            }
        }
    }
}
